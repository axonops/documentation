# What is AxonOps™ Workbench for Cassandra®?
...
Apache Cassandra is a genuinely open-source, distributed database known for its exceptional scalability, high availability, and performance. Initially released as an open-source project in 2008, Cassandra has since become a top-level project under the Apache Software Foundation. It is trusted by thousands of companies worldwide, including major organizations like Netflix, Apple, and American Express, to handle their mission-critical data needs.
