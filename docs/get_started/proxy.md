---
title: "axon-agent behind a proxy"
...
If your network does not have direct internet access and it requires a proxy to connect to the AxonOps Server, you will need to configure axon-agent to use it.

To configure the axon-agent to use a proxy, you can use a `systemd` override. This is the recommended approach as it keeps your configuration separate from the agent's default service file.
